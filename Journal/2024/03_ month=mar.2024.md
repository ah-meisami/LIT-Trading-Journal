...
| `XU` |
| :---: |
| `I was wrong.` `Market is in consolidation mode not trending mode.` `every tap & DB is incorrect in this pic` ___ `try to understand when market enter consolidation mode` |
