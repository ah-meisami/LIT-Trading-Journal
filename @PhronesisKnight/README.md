...
- every breaker-block-mitigation once mitigated => the moments price return back to that area => that breaker-block-mitigation automatically becomes liquidity.
